  ...
  <div className='w-full p-4 xl:px-12 h-auto xl:py-10 rounded-lg shadow-shadowOne flex flex-col
    ...
    <div className='flex items-center justify-between'>
      ...
      <div className='flex gap-2'>
        ...
        justify-center items-center text-gray-400 hover:text-designColor duration-100 cursor-pointer">
        <BsGithub/>
        </span>
        <span className="text-lg w-10 h-10 rounded-full bg-black inline-flex
     ...
     <p className='text-sm tracking-wide mt-3 hover:text-gray-100 duration'>
      {des}
      </p>
    </div>
    </div>
