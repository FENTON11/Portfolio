...
const Banner = () => {
 const [text] = useTypewriter({
  ...
  return (
    <section 
    id='home'
    className='w-full pt-10 pb-10 py-20 flex items-center border-b-[1px] font-titleFont border-b-black'>
    ...
    <div className='absolute bottom-0 w-[500px] h-[500px] bg-gradient-to-r from-
