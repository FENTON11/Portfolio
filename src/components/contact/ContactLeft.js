...
import { FaPhoneAlt, FaTwitter,FaLinkedinIn,FaFacebookF} from "react-icons/fa"
const ContactLeft = () => {
  return (
    <div className="w-full lgl:w-[35%] h-full bg-gradient-to-r from-[#1e2024] to-[#23272b] p-8 rounded-lg shadow-shadowOne flex flex-col gap-8 justify-center">
       <div className="flex flex-col items-center justify-center">
          <FaPhoneAlt className="text-designColor" style={{ fontSize: '15rem' }} />
       </div>

     <div className="flex flex-col gap-4">
      <h3 className="text-3xl font-bold text-white">Fenton Mwangi</h3>
    ...
    <p className="text-base text-gray-400 flex items-center gap-2">
      Phone: <span className="text-lightText">+254706502923</span>
    </p>
    <p className="text-base text-gray-400 flex items-center gap-2">
      Email: <span className="text-lightText">fencurt99@gmail.com</span>
    </p>
  </div>
   <div className='flex flex-col gap-4'>
